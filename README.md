...
ver 1.5.4 
Пофикшены баги, сделаны варианты модулей на потоках для чекинга больше 10к проксей.  
## Что это такое?
...
2. Запускаем `python main.py` или если 2 питона `python3 main.py`. Или `./main.py` для пинусов.  
