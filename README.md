...
ver 1.5.3 
Пофикшены баги, временный костыль на автоопределение протокола в проксях в формате протокол://прокси:порт. ТОЛЬКО ДЛЯ ОДНОГО ПРОТОКОЛА ЗА ОДИН ЦИКЛ РАБОТЫ ПРОКСИ МАСТЕРА!  
## Что это такое?
...
4. Берем готовый продукт из `proxies.txt`, забаненные прокси в `texts/banned.txt`, мертвые прокси в `texts/died.txt`  
