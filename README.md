...
ver 1.5.3 
Пофикшены баги, временный костыль на автоопределение протокола в проксях в формате протокол://прокси:порт. ТОЛЬКО ДЛЯ ОДНОГО ПРОТОКОЛА ЗА ОДИН ЦИКД РАБОТЫ ПРОКСИ МАСТЕРА!  
## Что это такое?
